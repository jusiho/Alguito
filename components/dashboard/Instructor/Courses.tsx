                  ...
                  <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-3">
                     <div className="flex items-center justify-between mb-4">
                        <div className="flex-shrink-0">
                           <span className="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Cursos</span>
                           <h3 className="text-base font-normal text-gray-500">Crea tus secciones y sus lecciones</h3>
                        </div>
                     ...
                     <div className="flex items-center justify-between mb-4">
                      <div className="flex">
                        ...
                        <Link href="instructor/crear-curso">
                           <a className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                           Crear Curso
                           </a>
                        </Link>
                      </div>
